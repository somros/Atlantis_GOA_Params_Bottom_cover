...
rasters_to_atlantis <- function(bc_raster){
  ...
  bc_raster <- bc_raster %>% projectRaster(crs=crs(atlantis_box)@projargs)
  bc_masked <- mask(bc_raster, atlantis_box %>% filter(!boundary & .bx0>91 & botz<0))
